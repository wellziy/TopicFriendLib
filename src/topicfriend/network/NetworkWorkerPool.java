...
public class NetworkWorkerPool
{
	...
	public static void initNetworkWorkerPool(int minThreadCount,int maxThreadCount)
	{
		...
		s_receiveSockets=new HashSet<Socket>();
		s_badSockets=new HashSet<Socket>();
		s_receiveBuffers=new ArrayList<NetworkBuffer>();
		s_sendBuffers=new ArrayList<NetworkBuffer>();
		s_threads=new ArrayList<Thread>();
